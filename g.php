    ...
    <section class="register" id="register">
        ...
        <form action="code.php" name="form1" method="post">
            ...
            <option value="">Select Doctor Name </option>
                <option value="Dr.D.K Sharma(M.B.B.S)">Dr.D.K Sharma(M.B.B.S)</option>
                <option value="Dr. I.R.Singh(M.B.B.S/AIIMS)">Dr. I.R.Singh(M.B.B.S/AIIMS)</option>
                <option value="Dr. D.M.Waghmare(M.B.B.S)"> Dr. D.M.Waghmare(M.B.B.S)</option>
