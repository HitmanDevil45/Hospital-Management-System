    ...
    <section class="register" id="register">
        ...
        <form action="code.php" name="form1" method="post">
            ...
            <option value="">Select Doctor Name </option>
                <option value="Dr.A.S.Patil(M.B.B.S/MS)">Dr.A.S.Patil(M.B.B.S/MS)</option>
                <option value="Dr.A.C.Chavan(M.B.B.S/MS)">Dr.A.C.Chavan(M.B.B.S/MS)</option>
                <option value="Dr.G.S.Raut(M.B.B.S/MS)"> Dr.G.S.Raut(M.B.B.S/MS)</option>
