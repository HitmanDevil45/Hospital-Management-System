    ...
    <section class="register" id="register">
        ...
        <form action="code.php" name="form1" method="post">
            ...
            <option value="">Select Doctor Name </option>
                <option value="Dr.P.P.Patil(B.D.S)">Dr.P.P.Patil(B.D.S)</option>
                <option value="Dr.D.S.Shinde(B.D.S)">Dr.D.S.Shinde(B.D.S)</option>
                <option value="Dr.V.R.Sharma(B.D.S)"> Dr.V.R.Sharma(B.D.S)</option>
