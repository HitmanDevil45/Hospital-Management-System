    ...
    <section class="register" id="register">
        ...
        <form action="code.php" name="form1" method="post">
            ...
            <option value="">Select Doctor Name </option>
                <option value="Dr.A.K Sharma(MD)">Dr.A.K Sharma(MD)</option>
                <option value="Dr. M.S.Singh(MD)">Dr. M.S.Singh(MD)</option>
                <option value="Dr. A.P.Shinde(MD)"> Dr. A.P.Shinde(MD)</option>
